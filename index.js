...
// const SCOPES = ['https://mail.google.com/']; // For full access
...
//         // Save the refresh token securely in your database (for now, just log it)
...
//         const otp = generateOtp(); // Save user with OTP to the database 
...
//     if (!user) {
//         return res.status(404).json({ message: 'No account found with that email and name.' });
//     }
...
//         if (!accessToken) {
//             return res.status(500).json({ message: 'Access token is not available. Please reauthenticate.' });
//         }
...
//             res.status(200).json({ success: true, message: 'Password has been sent to your email address.' });
//         });
//     } catch (error) {
//         console.error('Error retrieving access token:', error);
//         res.status(500).json({ message: 'Error retrieving access token. Please reauthenticate.' });
//     }
// });

// // Other routes (Get User, Add Notes, Edit Note, Get All Notes, Delete Note, Update isPinned, Search Notes) go here...
